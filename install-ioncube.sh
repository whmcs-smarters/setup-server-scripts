...
echo "zend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" > /etc/php/${VER_PHP}/apache2/conf.d/ioncube.ini
echo "zend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" >> /etc/php/${VER_PHP}/cli/php.ini
sed -i "zend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" /etc/php/${VER_PHP}/apache2/php.ini
sleep 3s
